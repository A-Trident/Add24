    ...
    u &&
      ...
      (function m() {
        let u = {
          ...
          n = t('input[name="source"]');
        n.length > 0 &&
          n.each(function (e) {
            u.referer_url && t(this).val(u.referer_url);
          });
        let r = t('input[name="utm_campaign"]');
        r.length > 0 &&
          r.each(function (e) {
            u.utm_campaign && t(this).val(u.utm_campaign);
          });
        let i = t('input[name="utm_source"]');
        i.length > 0 &&
          i.each(function (e) {
            u.utm_source && t(this).val(u.utm_source);
          });
        let a = t('input[name="utm_medium"]');
        a.length > 0 &&
          a.each(function (e) {
            u.utm_medium && t(this).val(u.utm_medium);
          });
        let c = t('input[name="utm_term"]');
        c.length > 0 &&
          c.each(function (e) {
            u.utm_term && t(this).val(u.utm_term);
          });
      })();
  });
  function e(t) {
...
})("CollectedForms-6458328", 0, {
  crossorigin: "anonymous",
  "data-leadin-portal-id": 6458328,
  "data-leadin-env": "prod",
  "data-loader": "hs-scriptloader",
  "data-hsjs-portal": 6458328,
  "data-hsjs-env": "prod",
...
})("hs-ads-pixel-6458328", 0, {
  "data-ads-portal-id": 6458328,
  "data-ads-env": "prod",
  "data-loader": "hs-scriptloader",
  "data-hsjs-portal": 6458328,
  "data-hsjs-env": "prod",
...
!(function (t, e, r) {
  if (!document.getElementById(t)) {
    var n = document.createElement("script");
    for (var a in ((n.src = "https://js.hs-banner.com/v2/6458328/banner.js"),
    (n.type = "text/javascript"),
    (n.id = t),
    r))
      r.hasOwnProperty(a) && n.setAttribute(a, r[a]);
...
!(function (e, t) {
  if (!document.getElementById(e)) {
    ...
    (c.src = "https://js.hs-analytics.net/analytics/1684911900000/6458328.js"),
    ...
    this.wpcf7_redirect_mailsent_handler = function () {
      document.addEventListener(
        ...
        function (event) {
          ...
          if (
            typeof event.detail.apiResponse != "undefined" &&
            event.detail.apiResponse
          ) {
            var apiResponse = event.detail.apiResponse;
            var actionDelay = 0;
            if (
              typeof apiResponse.api_url_request != "undefined" &&
              apiResponse.api_url_request
            ) {
              wpcf7_redirect.handle_api_action(apiResponse.api_url_request);
            }
            if (
              typeof apiResponse.api_json_xml_request != "undefined" &&
              apiResponse.api_json_xml_request
            ) {
              wpcf7_redirect.handle_api_action(
                apiResponse.api_json_xml_request
              );
            }
            if (
              typeof apiResponse.FireScript != "undefined" &&
              apiResponse.FireScript
            ) {
              actionDelay =
                typeof apiResponse.FireScript.delay_redirect != "undefined"
                  ? apiResponse.FireScript.delay_redirect
                  : actionDelay;
            ...
            if (
              typeof apiResponse.redirect_to_paypal != "undefined" &&
              apiResponse.redirect_to_paypal
            ) {
              actionDelay =
                typeof apiResponse.redirect_to_paypal.delay_redirect !=
                "undefined"
                  ? apiResponse.redirect_to_paypal.delay_redirect
                  : actionDelay;
              window.setTimeout(function () {
                wpcf7_redirect.handle_redirect_action(
                  apiResponse.redirect_to_paypal
                );
              }, actionDelay);
            }
            if (
              typeof apiResponse.redirect != "undefined" &&
              apiResponse.redirect
            ) {
              actionDelay =
                typeof apiResponse.redirect.delay_redirect != "undefined"
                  ? apiResponse.redirect.delay_redirect
                  : actionDelay;
              window.setTimeout(function () {
    ...
    this.handle_redirect_action = function (redirect) {
      ...
      $.each(redirect, function (k, v) {
        ...
        window.setTimeout(
          function (v) {
            var redirect_url =
              typeof v.redirect_url != "undefined" && v.redirect_url
                ? v.redirect_url
                : "";
